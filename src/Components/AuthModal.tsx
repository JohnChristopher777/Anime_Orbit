    ...
    >
      ...
      >
        ...
        <div className="text-center space-y-1">
          <div className="inline-flex items-center gap-1 text-[#ffd700] text-xs font-bold uppercase tracking-wider font-montserrat mb-1">
            <Sparkles size={14} />
          ...
          <p className="text-xs text-neutral-400">
            {mode === "login"
              ? "Sign in to access your custom watchlist and favorites"
              : mode === "signup"
              ? "Create an account to start tracking anime"
        ...
        {mode !== "forgot" && (
          <div>
            <button
              ...
              disabled={loading}
              className="w-full py-2.5 bg-white/5 hover:bg-white/10 border border-white/15 rounded-xl text-xs font-bold font-montserrat text-white flex items-center justify-center gap-2.5 transition-all"
            >
            ...
            <div className="flex items-center gap-3 my-4">
              ...
              <span className="text-[11px] text-neutral-500 font-bold uppercase">or</span>
              <div className="flex-1 h-px bg-white/10" />
            </div>
          </div>
        )}
          ...
          {mode !== "forgot" && (
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 bg-white/5 border border-white/15 focus:border-[#ffd700] rounded-xl text-xs sm:text-sm text-white outline-none"
              />
              <button
                type="button"
