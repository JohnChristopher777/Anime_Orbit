  ...
  return (
    <div className="min-h-screen flex flex-col"><main className="min-h-[75vh] flex flex-1 items-center justify-center px-5 py-16">
      ...
      <div className="w-full max-w-lg text-center">
        ...
        />
        <span className="mt-7 block text-xs font-black uppercase tracking-[0.2em] text-[#ffd700]">404 · Lost in orbit</span>
        <h1 className="mt-2 font-montserrat text-2xl sm:text-4xl font-black tracking-tight">Even Zoro couldn’t find this page.</h1>
        <p className="mt-3 text-sm leading-relaxed text-neutral-400">The address may have changed, or this route never existed.</p>
        <div className="mt-7 flex items-center justify-center gap-3">
          ...
          <Link to="/" className="inline-flex items-center gap-2 rounded-full bg-[#ffd700] px-5 py-2.5 text-sm font-black text-black hover:bg-[#ffe44d]">
            <Home size={16} /> Home
          </Link>
        </div>
      </div>
