...
//   const safeTrendingAnime = trendingAnime.length ? trendingAnime : safePopularAnime; // Fallback to popular if trending is empty
...
//       {/* Trending Anime Section (Horizontal Scrollable, 10 Numbered Results) */}
...
//     flex-direction: column;
//     align-items: center;
//     min-width: 120px; /* Smaller width for compact display */
//     padding: 0.5rem;
